...
" Text Formatting/Layout {
    ...
    au BufNewFile,BufReadPost *.coffee setl shiftwidth=2 expandtab " For CoffeeScript
...
" Mappings {
    ...
    nnoremap <Leader>ft :set softtabstop=4 shiftwidth=4 expandtab<return>:retab<return>
    " Write as super user
